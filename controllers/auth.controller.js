...
const client = new OAuth2Client("346173711034-9v4f1b4hstrbjagq5ugdlf7nd66uplfh.apps.googleusercontent.com")
...
module.exports.googleLogin = (req, res) => {
  ...
  client.verifyIdToken({ idToken: tokenId, audience: "346173711034-9v4f1b4hstrbjagq5ugdlf7nd66uplfh.apps.googleusercontent.com" }).then(response => {
